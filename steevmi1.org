...
#+begin_src emacs-lisp
  (setq org-archive-location "~/.local/org-mode/archive.org::From %s")
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq org-directory "~/.local/org-mode")
  ;; Set to <your Dropbox root directory>/MobileOrg.
  ;;(setq org-mobile-directory "~/Dropbox/MobileOrg")
  ;; Set to the files (or directory of files) you want sync'd
  (setq org-agenda-files (quote ("~/.local/org-mode"
                                 "~/Documents/Novartis/NIBR.org")))
  ;; Set to the name of the file where new notes will be stored
  ;;(setq org-mobile-inbox-for-pull "~/.local/org-mode/from-mobile.org")
