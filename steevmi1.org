...
To use the customizations here yourself, /you must change the name of
 ...
 is 'steevmi1', so this file is named =steevmi1.org=, and when Emacs
...
#+begin_src emacs-lisp
  (setq org-archive-location "~/Library/org-mode/archive.org::From %s")
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq org-directory "~/Library/org-mode")
  ;; Set to <your Dropbox root directory>/MobileOrg.
  ;;(setq org-mobile-directory "~/Dropbox/MobileOrg")
  ;; Set to the files (or directory of files) you want sync'd
  (setq org-agenda-files (quote ("~/Library/org-mode"
                                 "~/SCICOMP/novartis.org")))
  ;; Set to the name of the file where new notes will be stored
  ;;(setq org-mobile-inbox-for-pull "~/Library/org-mode/from-mobile.org")
...
** Pianobar
[2014-04-17 Thu 09:48]
Load up pianobar.

#+srcname: pianobar
#+begin_src emacs-lisp
(require 'pianobar)
(setq pianobar-username "pandora@raingods.net")
#+end_src
