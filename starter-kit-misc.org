...
#+begin_src emacs-lisp
;; Disabling this to work around problem trying to commit in git.
;;  https://github.com/magit/magit/issues/1014
...
[2013-05-14 Tue 10:27]
** Scrolling behavior
Make scrolling a bit better when using keyboard to move around.
