...
#+begin_src emacs-lisp :tangle yes
  (setq org-default-notes-file "~/Library/org-mode/refile.org")
  ...
  (setq org-capture-templates
        (quote (("t" "todo" entry (file "~/Library/org-mode/refile.org")
                 "* TODO %?\n%U\n%a\n  %i" :clock-in t :clock-resume t)
                ("n" "note" entry (file "~/Library/org-mode/refile.org")
                 "* %? :NOTE:\n%U\n%a\n  %i" :clock-in t :clock-resume t)
                ("j" "Journal" entry (file+datetree "~/Library/org-mode/diary.org")
                 "* %?\n%U\n  %i" :clock-in t :clock-resume t)
                ("w" "org-protocol" entry (file "~/Library/org-mode/refile.org")
                 "* TODO Review %c\n%U\n  %i" :immediate-finish t)
                ("m" "Meeting" entry (file "~/Library/org-mode/refile.org")
                 "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
                ("p" "Phone call" entry (file "~/Library/org-mode/refile.org")
                 "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
                ("h" "Habit" entry (file "~/Library/org-mode/refile.org")
...
#+begin_src emacs-lisp
  ...
  ;;  Added this 11 June 2013, from http://kangtu.me/~kangtu/pavilion.html
  (define-skeleton org-r-codeblock-skeleton
  "R code block for a emacs-org file."
  "Name: "
  "#+name: " str "\n"
  "#+ATTR_LaTeX: width=10cm\n"
  "#+begin_src R :session *R* :cache yes :exports both :file test.png :results output graphics :width 800 :height 480\n\n"
  "#+end_src\n"
)
(define-abbrev org-mode-abbrev-table "rblk" "" 'org-r-codeblock-skeleton)

;; define beamer header
(define-skeleton org-beamer-header-skeleton
  "Beamer header for a emacs-org file."
  "Beamer header: "
...
(define-abbrev org-mode-abbrev-table "bmrblk" "" 'org-beamer-header-skeleton)
