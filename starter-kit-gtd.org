...
#+begin_src emacs-lisp :tangle yes
  (setq org-default-notes-file "~/.local/org-mode/refile.org")
  ...
  (setq org-capture-templates
        (quote (("t" "todo" entry (file "~/.local/org-mode/refile.org")
                 "* TODO %?\n%U\n%a\n  %i" :clock-in t :clock-resume t)
                ("n" "note" entry (file "~/.local/org-mode/refile.org")
                 "* %? :NOTE:\n%U\n%a\n  %i" :clock-in t :clock-resume t)
                ("j" "Journal" entry (file+datetree "~/.local/org-mode/diary.org")
                 "* %?\n%U\n  %i" :clock-in t :clock-resume t)
                ("w" "org-protocol" entry (file "~/.local/org-mode/refile.org")
                 "* TODO Review %c\n%U\n  %i" :immediate-finish t)
                ("m" "Meeting" entry (file "~/.local/org-mode/refile.org")
                 "* MEETING %? :MEETING:\n%U" :clock-in t :clock-resume t)
                ("p" "Phone call" entry (file "~/.local/org-mode/refile.org")
                 "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
                ("h" "Habit" entry (file "~/.local/org-mode/refile.org")
