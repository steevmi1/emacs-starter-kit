...
#+begin_src sh :exports none
cd ~/Documents/git/org-mode && git describe HEAD
#+end_src
...
I keep a copy of the org-mode =git= repository in =~/Documents/git/org-mode/=.  This clone
was created with
#+begin_src sh
cd ~/Documents/git
...
(setq org-agenda-files (quote ("~/Documents/git/org"
                               "~/Documents/git/org/client1"
                               "~/Documents/git/client2")))
#+end_src
...
In the example above I have =~/Documents/git/client2= in a separate git
repository from ~/Documents/git/org.  This gives me the flexibility of leaving
...
=org-agenda-files= on this laptop does not include the =~/Documents/git/client2=
directory.
** Org File Structure
:PROPERTIES:
...
(setq org-default-notes-file "~/Documents/git/org/refile.org")
...
(setq org-capture-templates
      (quote (("t" "todo" entry (file "~/Documents/git/org/refile.org")
               "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
              ("r" "respond" entry (file "~/Documents/git/org/refile.org")
               "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
              ("n" "note" entry (file "~/Documents/git/org/refile.org")
               "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
              ("j" "Journal" entry (file+datetree "~/Documents/git/org/diary.org")
               "* %?\n%U\n" :clock-in t :clock-resume t)
              ("w" "org-protocol" entry (file "~/Documents/git/org/refile.org")
               "* TODO Review %c\n%U\n" :immediate-finish t)
              ("m" "Meeting" entry (file "~/Documents/git/org/refile.org")
               "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
              ("p" "Phone call" entry (file "~/Documents/git/org/refile.org")
               "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
              ("h" "Habit" entry (file "~/Documents/git/org/refile.org")
...
,* TODO 
  ...
  [[file:~/Documents/git/org-mode-doc/org-mode.org::*Capture%20Tasks%20is%20all%20about%20being%20FAST][Capture Tasks is all about being FAST]]
#+end_src
...
#+header: :tangle yes
#+begin_src emacs-lisp
(setq org-ditaa-jar-path "~/Documents/git/org-mode/contrib/scripts/ditaa.jar")
...
(setq org-publish-project-alist
      ...
      (quote (("norang-org"
               :base-directory "~/Documents/git/www.norang.ca"
              ...
              ("doc-org"
               :base-directory "~/Documents/git/doc.norang.ca/"
              ...
              ("doc-private-org"
               :base-directory "~/Documents/git/doc.norang.ca/private"
              ...
              ("org-org"
               :base-directory "~/Documents/git/org/"
              ...
              ("org-mode-doc-org"
               :base-directory "~/Documents/git/org-mode-doc/"
               :publishing-directory "/ssh:www-data@www:~/doc.norang.ca/htdocs"
               :recursive t
               :section-numbers nil
               :table-of-contents nil
...
for any org files under =~/Documents/git/doc.norang.ca/someclient/= if that is
...
(setq org-agenda-diary-file "~/Documents/git/org/diary.org")
#+end_src
...
creates date entries in the =~/Documents/git/org/diary.org= file.
...
#+header: :tangle no
#+begin_src emacs-lisp
(add-to-list 'load-path (expand-file-name "~/Documents/git/org-mode/contrib/lisp"))
...
#+header: :tangle yes
#+begin_src emacs-lisp
(add-to-list 'Info-default-directory-list "~/Documents/git/org-mode/doc")
#+end_src
...
#+header: :tangle yes
#+begin_src emacs-lisp
;;  Remove the load-path, since it's throwing a warning and we don't 
;;  strictly need this.
...
~/Documents/git/bzflag/trunk/bzflag/src/bzflag/bzflag -directory ~/Documents/git/bzflag/trunk/bzflag/data $*
