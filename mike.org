...
To use the customizations here yourself, /you must change the name of
 ...
 is 'mike', so this file is named =mike.org=, and when Emacs
 starts up with the starter kit it creates the file =mike.el=.
 
You will also need to change the values for the location of bibtex
 databases, pandoc and orgmode-mobile specified below, and some other
 settings. *Search for 'mike' in this file* to find the paths that
...
#+begin_src emacs-lisp    
    ...
    '("/Users/mike/Library/texmf/bibtex/bib"))

    ;; Default bibliography
    (setq reftex-default-bibliography
    '("/Users/mike/Documents/bibs/socbib.bib"))
#+end_src
